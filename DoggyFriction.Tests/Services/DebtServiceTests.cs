...
namespace DoggyFriction.Tests.Services
{
    ...
    public class DebtServiceTests
    {
        ...
        public void GetDebts_SponsorBoughtAndGaveSomeToFriend_ShouldAccountSomePartToFriend()
        {
            ...
            var action =
                fixture.Build<Action>().With(a => a.Goods, new[] {good}).With(a => a.Sponsors, new[] {sponsorBought}).Create();
        ...
        public void GetDebts_OneBoughtAndOneConsumedTwoGoods_ShouldAccountToConsumer()
        {
            ...
            var action =
                fixture.Build<Action>().With(a => a.Goods, new[] {good1, good2}).With(a => a.Sponsors, new[] {sponsor}).Create();
        ...
        public void GetDebts_OneDudeBoughtToAnotherAndControversial_ShouldMutuallyDisposeDebts()
        {
            ...
            var action1 = fixture.Build<Action>().With(a => a.Goods, new[] {good1}).With(a => a.Sponsors, new[] {dudeA}).Create();
            var action2 = fixture.Build<Action>().With(a => a.Goods, new[] {good2}).With(a => a.Sponsors, new[] {dudeB}).Create();
